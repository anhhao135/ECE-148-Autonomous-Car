...
class LineFollower(object):
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber(
            "camera_rgb", Image, self.camera_callback)
    ...
    def camera_callback(self, data):
        ...
        descentre = 160
        rows_to_watch = 20
        cv_image = cv_image[(height) / 2 + descentre:(height) /
        ...
        imgage, contours, hierarchy = cv2.findContours(
        ...
        for pic, contour in enumerate(contours):
            ...
            # Se obtiene el centro de masa de los marcadores enconrados.
...
def main():
    ...
    throttle_pub = rospy.Publisher(
        'throttle', Float32, queue_size=1)  # set up publishers
